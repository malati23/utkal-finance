...
export function NoticeTicker() {
  return (
    <section className="my-4 bg-gradient-to-r from-[#003B95] via-[#002B7A] to-[#003B95] text-white py-3 px-4 sm:px-8 border-y border-blue-500/50 shadow-md relative z-10">
      <div className="max-w-7xl mx-auto flex items-center gap-4">
        ...
        <div className="overflow-hidden relative w-full text-xs sm:text-sm font-medium text-slate-100">
