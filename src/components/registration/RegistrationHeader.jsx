    ...
    <header className="bg-white border-b border-slate-200/90 shadow-xs sticky top-0 z-40 w-full">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 sm:py-4 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          <button
            onClick={() => navigate('/')}
            className="p-2 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-700 transition-colors border border-slate-200 shrink-0"
        ...
        <div className="hidden md:flex items-center gap-2.5">
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-[#0B1528] hover:bg-slate-900 text-white text-xs font-bold transition-colors border border-slate-800 shadow-xs"
          >
      ...
      {mobileMenuOpen && (
        <div className="md:hidden bg-slate-50 border-t border-slate-200 px-4 py-3 space-y-2 shadow-lg">
          ...
          <button
            ...
            className="w-full flex items-center justify-between px-3.5 py-2.5 rounded-xl bg-[#0B1528] text-white text-xs font-bold"
          >
            <span className="flex items-center gap-2">
              <Shield className="w-4 h-4 text-emerald-400" />
              <span>Admin Portal</span>
